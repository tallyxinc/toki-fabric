...
contract('TokiFabric', accounts => {
    ...
    it('should create toki cause msg.sender != allowed to create toki', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
    ...
    it('should create toki cause toki owner == address(0)', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
    ...
    it('should create toki cause toki beneficiary == address(0)', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
     ...
     it('should create toki cause toki value == 0', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
    ...
    it('should create toki cause toki payDate == 0', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
    ...
    it('should create toki cause toki owner == toki beneficiary', async () => {
    	let tokiId = "034dfcf3-066a-459b-ab62-3b8dbfa0ca76";
    	let assetReference = "PI-887655RPN";
    	let tokiOwner = accounts[1];
    	let tokiBeneficiary = accounts[2];
